...
export class BooksComponent {
  ...
  constructor(){
    ...
    let book008 = new Book("Sombras","Ciencia Ficcion","E.King",19,"https://media.revistagq.com/photos/5f6c9b117458e06669aaa2b0/master/w_1643,h_2500,c_limit/6%20resplandor.jpg",3,5);
    let book009 = new Book("La Bestia","Ciencia Ficcion","E.King",19,"https://images-na.ssl-images-amazon.com/images/I/81c8No6mSPL.jpg?w=144",1,2);
